"""Forked from rlms library -- types shared across core, clients, and environments."""
...
class QueryMetadata:
    ...
    def __init__(self, prompt: str | list[str] | dict[Any, Any] | list[dict[Any, Any]]) -> None:
